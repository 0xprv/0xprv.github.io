...
- Reduced response time by **60%** while supporting **50+ concurrent calls**  
- Integrated LLaMA 3.1 8B with a Retrieval-Augmented Generation (RAG) pipeline achieving **92% query resolution accuracy**  
- Implemented ultra-low latency voice synthesis using Coqui TTS (**<200ms latency**)  
- Designed scalable SIP-based telephony using PJSUA2, supporting multiple providers  
- Built real-time monitoring dashboard using React + TypeScript  
- Integrated structured + unstructured data sources into LLM memory layer for RAG  

**Tech Stack:**  
`Python` • `React (TypeScript)` • `LangChain` • `PJSUA2` • `RAG Systems`
...
- Specialized in ML systems, APIs, and distributed infrastructure  
- Maintained consistent **5★ rating across 15+ projects**
...
- Built privacy-preserving identity system using biometric authentication + blockchain  
- Implemented Zero-Knowledge Proofs (zk-SNARKs) with Merkle Trees  
- Deployed on Ethereum mainnet following W3C SSI standards  
- Developed full-stack system including biometric processing, cryptographic proofs, and web interface  
...
- Covered fundamentals to advanced architectures and deployment  
- Focused on production-oriented ML workflows  
